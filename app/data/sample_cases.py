...
SAMPLE_CASES: List[Case] = [
    ...
    Case(
        ...
        case_type="analysis",
        data_profile="customer_analytics",
    ...
    Case(
        ...
        case_type="analysis",
        data_profile="performance_metrics",
